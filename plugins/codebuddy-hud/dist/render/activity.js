...
function renderToolsSegment(tools) {
    if (tools.length === 0)
        return null;
...
function renderTasksSegment(tasks) {
    if (tasks.length === 0)
        return null;
...
export function renderActivityLine(ctx) {
