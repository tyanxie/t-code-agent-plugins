...
function splitAnsiTokens(
  str: string,
): Array<{ type: 'ansi' | 'text'; value: string }> {
...
function splitLineBySeparators(
  line: string,
): { segments: string[]; separators: string[] } {
